  ...
  const chargingMethods = [
    {
      ...
      icon: '🏠',
      details: Object.values(t.charging.home.details) as string[],
    ...
    },
    {
      ...
      icon: '🔌',
      details: Object.values(t.charging.public.details) as string[],
    ...
    },
    {
      ...
      icon: '⚡',
      details: Object.values(t.charging.fast.details) as string[],
